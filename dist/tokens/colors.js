 ...
 */
export function getAllColorTokens(theme = 'light') {
    const tokens = [];
 ...
 */
export function getColorByVariable(varName, theme = 'light') {
 ...
 */
export function generateColorCSSVariables(theme = 'light') {
